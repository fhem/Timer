...
<b>Attribute</b><br>
	...
	<ul><li><a name="Sunrise">Sonnenaufgang</a><br>
	Sonnenaufgang besteht aus vier Zonen, <br><br>"REAL" Sonne in der Horizontalen "HORIZON=0.0" <br> "CIVIL" Bürgerliche Dämmerung "HORIZON=-6.0" <br> "NAUTIC" Nautische Dämmerung "HORIZON=-12.0" <br> "ASTRONOMIC" Astronomische Dämmerung "HORIZON=-16.0"<br><br>Man kann unter den Wert auswählen wie der Stand beim Sonnenaufgang sein soll.</li><a name=" "></a></ul><br>
